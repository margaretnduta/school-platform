...
<div class="max-w-4xl mx-auto bg-white rounded-xl shadow p-8">
    ...
    <p class="text-sm text-gray-500 mb-6">Fill in your details below to apply for admission.</p>
    ...
    <form action="{{ route('student.admissions.store') }}" method="POST">
        @csrf

        <p class="text-sm font-semibold text-blue-900 mb-4 border-b pb-2">Personal Information</p>
        ...
        <p class="text-sm font-semibold text-blue-900 mb-4 border-b pb-2">Guardian / Parent Information</p>
