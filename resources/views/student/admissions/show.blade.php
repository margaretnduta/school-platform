...
<div class="max-w-3xl mx-auto bg-white rounded-xl shadow p-8">
    ...
    <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
        <p class="text-green-700 font-semibold">🎉 Congratulations! Your application was approved.</p>
        <p class="text-sm text-gray-600 mt-1">
            Admission Number: <span class="font-bold text-green-700">{{ $application->student->admission_number }}</span>
        </p>
        <p class="text-sm text-gray-600">
            Class: <span class="font-bold">{{ $application->student->class }}</span>
        </p>
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
        <p class="text-yellow-700 font-semibold">⏳ Pending Review</p>
        <p class="text-sm text-gray-600 mt-1">Your application is under review. Please check back later.</p>
    </div>
    @endif
